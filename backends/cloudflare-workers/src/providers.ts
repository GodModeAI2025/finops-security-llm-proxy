import { Env, PricingEntry } from "./types";
...
export const PROVIDERS: Record<string, ProviderConfig> = {
  ...
  google: {
    ...
    parse_usage: (body) =>
      body?.usageMetadata
        ? { input_tokens: body.usageMetadata.promptTokenCount ?? 0, output_tokens: body.usageMetadata.candidatesTokenCount ?? 0 }
        : null,
  },
};
...
export function getProviderKey(provider: string, env: Env): string {
